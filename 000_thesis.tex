...
\title{Fast Algorithms for Quasi-2D Coulomb Systems: Modeling, Simulation, and Applications}  % Title of the thesis.
...
\subject{Individualized Interdisciplinary Program} % Subject of the Degree.
...
\chapter{Quasi-2D Systems and Long Range Coulomb Interactions}
\label{chp_background}
\input{02_background.tex}
\newpage

\chapter{Fast Algorithms for Quasi-2D Coulomb Systems}
\label{chp_algorithms}
\input{03_algorithms.tex}
\newpage

\chapter{Applications of the Fast Algorithms}
\label{chp_applications}
\input{04_applications.tex}
\newpage
