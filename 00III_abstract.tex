...
Then, three innovative algorithms are developed: the sum-of-exponentials Ewald2D (SOEwald2D) method, the random batch Ewald2D (RBE2D) method, and the quasi-Ewald method (QEM), which are designed for simulating quasi-2D Coulomb systems in a homogeneous medium, dielectrically confined quasi-2D systems, and systems confined by meta-materials characterized by a negative dielectric constant, respectively.
