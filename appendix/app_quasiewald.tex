...
\begin{figure}[htbp]
    ...
    \caption{The lattice-like structure and the clusters for~$\gamma = \pm 10$ cases are shown in (a) and (b), respectively. Force in the $z$ direction on particles at different positions is shown in (b).}
    \label{fig:balls}
\end{figure}
