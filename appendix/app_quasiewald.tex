...
In the main text, we have shown that the charge oscillation can lead to lattice-like structure formation in dielectric-confined quasi-2D systems, and we mainly focused on the tunable lattice parameter.
...
For both cases, we attribute the cluster formation to the strong polarization charge with different sign on the substrate as shown in Fig.~1~(a) of the main text, which forms a deep potential well and traps these ions inside.
