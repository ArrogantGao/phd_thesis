...
\begin{equation}\label{eq::hk_qem_qem}
...
\begin{equation}\label{eq::RBapp_qem_qem}
...
\begin{equation}\label{eq::xichi_qem_qem}
...
\begin{prop}\label{prop:unbiased_qem_qem}
...
\end{align*}
on the basis of Lemma \ref{lem::upper_bound_phiRB_qem}, the upper bound of~$\abs{\grad_{\V{r}_i} \phi(\V{h})}$ can be estimated as follows 
\begin{equation}
