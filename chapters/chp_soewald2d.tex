...
\begin{figure}[ht]
	...
	\caption{
		...
		\rev{The unit for $z$ is $\sigma$, the unit for concentration is $\sigma^{-2}$, the unit of time is $\tau$ and the unit of MSD is $\sigma^2$.}
	}
	\label{fig:norm}
\end{figure}
...
\begin{figure}[ht]
	...
	\caption{
		...
		\rev{The unit for $z$ is $\sigma$, and the unit for concentration is $\sigma^{-2}$.}
	}
