...
\end{thm}
\begin{proof}
	By Proposition~\ref{prop:unbiased} and the definition of normalization factor $H$, one has
	\begin{equation}
		\begin{split}
			\mathbb{E}\Xi^2
...
Furthermore, one evaluates the MSDs along both the periodic dimensions (Fig.~\ref{fig:norm}(a)) and the non-periodic dimension (Fig.~\ref{fig:norm}(b)), which describe the particles' anisotropic dynamic properties across a wide range of time scales. 
