In this chapter, we first present the mathematical formulation and governing equations of quasi-2D Coulomb systems, along with the notations used throughout this thesis.
We then revisit the Ewald summation method for doubly periodic lattice sums and its extension to dielectric-confined systems through combination with the image charge method, as well as its reformulation.
