...
\subject{Individualized Interdisciplinary Program - Advanced Materials} % Subject of the Degree.
\department{Division of Emerging Interdisciplinary Areas (EMIA)}       % Department to which the thesis is submitted.
\advisor{Prof. GAN, Zecheng}     % Supervisor. Additional co-supervisor can be added using \member
\member{Prof. XIANG, Yang, Thesis Supervisor}
\member{Prof. LIU, Jin-Guo, Thesis Supervisor}
%\acting      % Uncomment for Accting department head
\depthead{Prof. Huamin QU}     % department head.
...
\label{chp_appendix_softwares}
\input{appendix/app_softwares.tex}
