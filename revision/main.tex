...
\ar{
    The word ``well-defined'' here refers to the potential satisfies the infinite boundary conditions, which is a necessary condition for the potential to be mathematically well-defined. A more detailed explanation has been added to the proposition.
}
...
\ar{
    A new chapter has been added as Appendix E to introduce the packages developed by the author. I introduced three main packages: \texttt{ExTinyMD.jl}, \texttt{EwaldSummations.jl} and \texttt{ChebParticleMesh.jl}, which are useful for the researcher who are interested in this thesis and the related topics.
}
